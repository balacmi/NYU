...
public class RentalInfo {	
	...
	private Id<BikesharingVehicle> vehId = null;
	...
	public Id<BikesharingVehicle> getVehId() {
		return vehId;
	}
	public void setVehId(Id<BikesharingVehicle> vehId) {
		this.vehId = vehId;
	}
	...
	public String toString() {
		...
		return Double.toString(startTime) + "," + Double.toString(endTime) + "," +
